...
from(
    ...
    , lvl_1.source_ctl_action                                                                       as source_ctl_action
    , 'I'                                                                                           as ctl_action
            ...
            from(
                ...
                from(
                    select
                        ...
                        , contract_version_sid
                        , source_ctl_action
                        , source_versionbegindate as start_dttm
                        , row_hash
                    from(
                        select
                        t2.contract,
                        ...
                        from(
                            ...
                            from(
                                ...
                                , sa.ctl_action         as source_ctl_action

drop table if exists custom_b2c_enrollment_and_collection_stg.t_dim_enrollment_type_snp_inc purge;
create table if not exists custom_b2c_enrollment_and_collection_stg.t_dim_enrollment_type_snp_inc (
   sid                    string

drop table if exists custom_b2c_enrollment_and_collection.t_dim_salary_project_agreement purge;

create table if not exists custom_b2c_enrollment_and_collection.t_dim_salary_project_agreement (
   sid                          string
   , num                        string

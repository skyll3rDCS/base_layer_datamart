drop table if exists custom_b2c_enrollment_and_collection.t_dim_salary_project_enrollment purge;
drop table if exists custom_b2c_enrollment_and_collection.t_fct_salary_project_enrollment purge;

create table if not exists custom_b2c_enrollment_and_collection.t_fct_salary_project_enrollment  (
   sid                                string
   , document_sid                     string

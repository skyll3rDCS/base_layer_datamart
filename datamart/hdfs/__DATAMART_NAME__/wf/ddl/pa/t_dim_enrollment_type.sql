drop table if exists custom_b2c_enrollment_and_collection.t_dim_enrollment_type purge;

create table if not exists custom_b2c_enrollment_and_collection.t_dim_enrollment_type (
   sid                    string

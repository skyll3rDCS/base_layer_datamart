drop table if exists custom_b2c_enrollment_and_collection_stg.t_dim_salary_project_enrollment_inc purge;

drop table if exists custom_b2c_enrollment_and_collection_stg.t_fct_salary_project_enrollment_inc purge;

create table if not exists custom_b2c_enrollment_and_collection_stg.t_fct_salary_project_enrollment_inc (
   sid                                string
   , document_sid                     string
